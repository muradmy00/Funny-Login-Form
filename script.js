...
const nocheat = () => button.textContent = 'No cheating 🙅&zwj;♂️';
const notouch = () => button.textContent = 'Login Now';

button.addEventListener('click', event => button.textContent = 'No Cheating man🎉🙃');
